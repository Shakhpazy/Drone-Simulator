...
//    private static final Date myDate = new Date();
     ...
     */
    public ArrayList<HashMap<String, Object>[]> processAllDrones(final double deltaTime) {
     ...
     */
    public void getRandomMove(DroneInterface theDrone, final double deltaTime) {
     ...
     */
    public void getMove(final DroneInterface theDrone, final double deltaTime) {
